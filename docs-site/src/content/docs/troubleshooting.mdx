...
| Not sure a download is genuine | [Verify it](/FolioOrb/download/#verify-your-download) against the release's `SHA256SUMS.txt`, and only download from [GitHub Releases](https://github.com/udhawan97/FolioOrb/releases) |
